  ...
  return (
    ...
    >
          ...
          <div className="relative h-[300px] sm:h-[400px] md:h-[500px] overflow-hidden bg-[#F9F7F0]">
            ...
            <button
              onClick={toggleZoom}
              className="absolute top-4 right-4 z-20 w-10 h-10 flex items-center justify-center bg-[#0A0A0A]/80 text-white hover:bg-[#FFD000] hover:text-[#0A0A0A] transition-all rounded-full"
            ...
            {zoomLevel > 1 && (
              <div className="absolute top-4 right-16 z-20 bg-[#FFD000] text-[#0A0A0A] px-2 py-1 text-xs font-bold">
                {zoomLevel}x
              </div>
            )}
...
function WorksSection() {
  ...
  const categories = ["All", "Web Services", "Brand Identity", "Social Media Designs"];
  ...
  const projects = [
    ...
    { 
      ...
      image: "/wedding-gallery/1.jpg",
      description: "A beautifully crafted wedding card designs that capture the essence of the couple's special day. Features elegant typography, custom illustrations, and cohesive color palettes.",
    ...
    { 
      ...
      gallery: [
        ...
        "/ramadan-gallery/2.jpg",
        "/ramadan-gallery/3.jpg",
        "/ramadan-gallery/4.jpg",
        "/ramadan-gallery/5.jpg",
        "/ramadan-gallery/6.jpg",
        "/ramadan-gallery/7.jpg"
      ]
    },
    { 
      ...
      gallery: [
        ...
        "/engagement-gallery/2.jpg",
        "/engagement-gallery/3.jpg",
        "/engagement-gallery/4.jpg",
        "/engagement-gallery/5.jpg",
        "/engagement-gallery/6.jpg",
        "/engagement-gallery/7.jpg",
        "/engagement-gallery/8.jpg"
      ]
    },
    { 
      ...
      gallery: [
        ...
        "/bridal-gallery/2.jpg",
        "/bridal-gallery/3.jpg",
        "/bridal-gallery/4.jpg",
        "/bridal-gallery/5.jpg",
        "/bridal-gallery/6.jpg",
        "/bridal-gallery/7.jpg",
        "/bridal-gallery/8.jpg",
        "/bridal-gallery/9.jpg",
        "/bridal-gallery/10.jpg"
      ]
    },
  ];
            ...
            <AnimatePresence mode="popLayout">
              {filteredProjects.map((project, index) => (
                <motion.div
                  ...
                  className="project-card-new group cursor-pointer bg-white border-2 border-[#0A0A0A] transition-all duration-300 hover:shadow-[8px_8px_0px_0px_rgba(255,208,0,1)]"
                >
                  {/* Image Container - No Crop */}
                  <div className="relative aspect-square bg-[#F9F7F0] overflow-hidden border-b-2 border-[#0A0A0A]">
                    <img
                      src={project.image}
                      alt={project.title}
                    ...
                    {/* Category Badge */}
                    <div className="absolute top-3 left-3 px-3 py-1 text-xs font-[family-name:var(--font-syne)] bg-[#FFD000] text-[#0A0A0A] font-bold border border-[#0A0A0A]">
                      {project.category}
                    </div>
                  ...
                  <div className="p-4 sm:p-5">
                    <h3 className="text-lg sm:text-xl font-[family-name:var(--font-bebas-neue)] text-[#0A0A0A] group-hover:text-[#FFD000] transition-colors">
                      {project.title}
                    </h3>
                    <p className="text-xs text-[#888888] font-[family-name:var(--font-dm-sans)] mt-1 line-clamp-2">
                      {project.description}
                    </p>
                  </div>
                </motion.div>
